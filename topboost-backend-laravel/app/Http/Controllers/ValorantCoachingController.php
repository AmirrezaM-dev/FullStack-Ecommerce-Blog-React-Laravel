...
class ValorantCoachingController extends Controller
{
	public function makePurchase(Request $request)
	{
		...
		if (!$error) {
			...
			$cart[] = ["Type of coaching", ValorantTOC::find($request->input("typeOfCustom"))->name, false];
		...
		$newCheckout = Checkouts::create([
			...
			'code' => $randomString,
			'title' => "You've purchased valorant coaching:",
