...
class LolNMController extends Controller
{
	public function makePurchase(Request $request)
	{
		...
		if (!$error) {
			...
			$price = $workingCurrentDivision["normal_price"] * $request->input("numberOfGames");
		...
		$newCheckout = Checkouts::create([
			...
			'code' => $randomString,
			'title' => "You've purchased league of legends normal boost:",
