			...
			jQuery.each(as, function (i, a) {
				...
				switch (a.action) {
					...
					case "stoplayer":
						...
						if (tnc.length > 0 && d && ((d.frames && d.frames[0].delay != "bytrigger") || (d.frames === undefined && d.start !== "bytrigger"))) {
							d.triggerstate = "on";
							//d.animdirection="in";		
	...
	var actionSwitches = function (tnc, opt, a, _nc) {
		switch (a.action) {
			case "scrollbelow":
				...
				a.speed = a.speed ? a.speed : 400;
				a.ease = a.ease ? a.ease : punchgs.Power2.easeOut;
