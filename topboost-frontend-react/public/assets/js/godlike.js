...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "options", function () { return options; });
		...
		var options = {
			...
			templates: {
				...
				cookieAlert: "<span class=\"nk-cookie-alert-close\"><span class=\"nk-icon-close\"></span></span>We use cookies to ensure you get the best experience on our website.<div class=\"nk-gap\"></div>\n            <span class=\"nk-cookie-alert-confirm nk-btn link-effect-4 nk-btn-bg-white nk-btn-color-dark-1\">Confirm</span>",
...
/* harmony import */ var _utility__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
		...
		function initSignForm() {
			...
			function animateForms($showItems) {
				var inverse = arguments.length > 1 && arguments[1] ? arguments[1] : false;
...
/* harmony import */ var _utility__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
		...
		function initCookieAlert() {
			var self = this;
			var confirmedCookieName = 'cookie_alert_dismissed';
			var expiration = 365;
