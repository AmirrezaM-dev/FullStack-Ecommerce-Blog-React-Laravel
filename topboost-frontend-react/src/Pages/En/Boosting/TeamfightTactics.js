...
import Solo from "./TeamfightTactics/Solo"
import Duo from "./TeamfightTactics/Duo"
import Win from "./TeamfightTactics/Win"
import PlacementMatches from "./TeamfightTactics/PlacementMatches"
import Coaching from "./TeamfightTactics/Coaching"
const TeamfightTactics = () => {
	const { api, TeamfightTacticsApi, setTeamfightTacticsApi } = useContexts()
	...
	useEffect(() => {
		if (!TeamfightTacticsApi) {
			api()
				.post("/TeamfightTactics/firstData")
				.then((response) => {
					const data = response.data
					if (data.message === "success") {
						setTeamfightTacticsApi(data)
						setIsScroll(true)
					}
				})
		} else {
				...
				<div className="nk-header-table">
					<div className="nk-header-table-cell">
						<div className="container">
							<h1 className="nk-title">Teamfight Tactics</h1>
				...
				<div className="nk-header-text-bottom">
					<div className="nk-breadcrumbs text-center">
						<ul>
							...
							<li>
								<Link to="/tft-boost">Teamfight Tactics</Link>
							</li>
							{service_name ? (
								<li>
					...
					<div className="d-flex card text-center">
						<div className="image">
							<img
								src={
									process.env.PUBLIC_URL +
									"/assets/images/tft-dis-left.png"
								}
								width={150}
							/>
						</div>
						<div className="image2">
							<img
								src={
									process.env.PUBLIC_URL +
									"/assets/images/tft-dis-right.png"
								}
								width={150}
							/>
						</div>
							...
							<div className="panel panel-default">
								...
								>
									<Link
										...
										to={"/tft-boost/placement-matches"}
										aria-expanded={
											service_name ===
												"placement-matches" && isOpen
												? "true"
